...
(function (t) {
    ...
    function initMouseDetection(t) {
        ...
        if (mouseDetectionEnabled || t) mouseDetectionEnabled && t && ($(document).unbind(e), mouseDetectionEnabled = !1); else {
            var i = !0, s = null;
    ...
    var menuTrees = [], IE = !!window.createPopup, mouse = !1, touchEvents = "ontouchstart" in window,
        mouseDetectionEnabled = !1, requestAnimationFrame = window.requestAnimationFrame || function (t) {
        ...
        hideAll: function () {
            ...
            init: function (t) {
                ...
                var e, i, s = t.dataSM("parent-a"), o = s.closest("li"), a = o.parent(), n = t.dataSM("level"),
                    ...
                    S = this.getViewportWidth(), b = this.getViewportHeight(),
